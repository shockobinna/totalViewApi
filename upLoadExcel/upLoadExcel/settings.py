...
SECRET_KEY = "django-insecure-xe@xncrf44f9h1gnvs8ckp+wo124vfj_yf3d1#*93mfuzuee%r"
...
STATIC_URL = "static/"
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "static"),  # This tells Django to look in the static folder
]
